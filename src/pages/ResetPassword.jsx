    ...
    <>
      ...
      <div className='relative w-screen h-dvh p-2 grid grid-cols-1 lg:grid-cols-[1fr,1.2fr] lg:gap-2'>
        <div className='flex flex-col p-4'>
          ...
          <p className='mt-auto mx-auto text-light-onSurfaceVariant dark:text-light-onSurfaceVariant text-bodyMedium lg:mx-0'>
            &copy; 2025 Oba.codes. All right reserved.
          </p>
        </div>
        ...
        <div className='hidden img-box lg:block lg:relative lg;rounded-large '>
          ...
          <p className='absolute bottom-10 left-12 right-12 z-10 text-displayLarge font-semibold leading-tight text-right text-light-onSurface drop-shadow-sm 2xl:text-[72px]'>
            Chat with Ask-Away to boost your creativity, productivity.
          </p>
        </div>
      </div>
